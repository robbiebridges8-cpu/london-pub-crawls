...
export const colorGroups: Record<string, { name: string; color: string; bg: string }> = {
...
export function getMapsUrl(pub: MonopolyPub): string {
  const q = encodeURIComponent(`${pub.pubName}, ${pub.address}, ${pub.postcode}`);
  return `https://www.google.com/maps/search/?api=1&query=${q}`;
}

export function getDirectionsUrl(fromPub: MonopolyPub, toPub: MonopolyPub): string {
