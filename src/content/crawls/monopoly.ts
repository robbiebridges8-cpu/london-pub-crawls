...
export const monopolyPubs: MonopolyPub[] = [
  ...
  },
  {
    ...
    price: 7.20,
    pintQuantity: "1",
    review: "The Minories is the first station on the route, an impressively sized venue, with an incredible interior showcasing exposed brick archways. Perfect atmosphere for winter drinks, but it doesn't have the brightest ambiance. Fortunately, there's a spacious beer garden to enjoy some morning sun in the summer.",
    color: "#000000",
    colorGroup: "station",
  ...
  },
  {
    ...
    price: 3.70,
    pintQuantity: "1/2",
    review: "Rounding off the browns brings you to the Hoop and Grapes in Whitechapel. One of the few timber-framed buildings to survive the Great Fire of 1666, The Hoop and Grapes is steeped in history. With a similarly dimly-lit interior to the Minories, you can stand out the front if it's a nice day.",
    color: "#8B4513",
    colorGroup: "brown",
  ...
  },
  {
    ...
    price: 3.08,
    pintQuantity: "1/2",
    review: "After getting off the Tube at Angel, head to this lively courtyard pub just off Camden Passage. Camden Head kicks off a wonderfully pleasant phase of the crawl, where the spirits are high and the sun is (hopefully) shining bright.",
    color: "#87CEEB",
  ...
  },
  {
    ...
    price: 3.85,
    pintQuantity: "1/2",
    review: "One of the best pubs on the entire crawl. Make sure you head up to the terrace, and if you can squeeze in a pint somewhere, do it here. The sun shining on the terrace can feel like you've teleported to a continental European city. Fun fact: the Hatton Garden heist of Easter weekend 2015 was planned here - look out for the commemorative blue plaque inside. The first of the longer walks starts from here, taking you across to our third station.",
    color: "#87CEEB",
    colorGroup: "lightBlue",
  ...
  },
  {
    ...
    price: 3.25,
    pintQuantity: "1/2",
    review: "The light blues aren't the most coveted set on the standard Monopoly board, but they're comfortably the strongest colour on the crawl. Housed in a stunning neo-classical stone lodge at the front of Euston station, The Euston Tap is a craft beer paradise. Over 30 keg lines and a huge bottle selection crammed into a nicely compact space. One of London's finest beer bars to cap off the elite light blues - don't rush this one.",
    color: "#87CEEB",
    colorGroup: "lightBlue",
  ...
  },
  {
    ...
    price: 4.50,
    pintQuantity: "1/2",
    review: "The Audley is situated in the heart of Mayfair, one of London's most expensive areas. As you might expect from the first of the dark blues, the beer isn't the cheapest here, but the quality of the venue is also what you would expect from the second-most lucrative property on the board. Stand outside and appreciate the supercars that pass by.",
    color: "#00008B",
    colorGroup: "darkBlue",
  ...
  },
  {
    ...
    price: 4.10,
    pintQuantity: "1/2",
    review: "Situated right on Trafalgar Square with Nelson's Column looming outside, The Admiralty is a spacious pub with a nautical theme. The location is unbeatable - grab a seat outside and drink in the surroundings.",
    color: "#FF0000",
    colorGroup: "red",
  ...
  },
  {
    ...
    price: 3.50,
    pintQuantity: "1/2",
    review: "The Moon Under Water is named after George Orwell's essay about his ideal pub. This Wetherspoons takes up a huge space on Leicester Square. Enjoy the cheap prices, but as with most Wetherspoons, the sooner you get out of here the better.",
    color: "#FFD700",
    colorGroup: "yellow",
  ...
  },
  {
    ...
    price: 3.90,
    pintQuantity: "1",
    review: "The Coach House is a cosy pub tucked just off Coventry Street in the heart of theatreland. It's a welcome escape from the West End crowds, with comfortable seating and a decent drinks selection. It feels like the beginning of the home stretch - 5 to go.",
    color: "#FFD700",
    colorGroup: "yellow",
