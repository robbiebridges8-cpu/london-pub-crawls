...
export const crawls: Crawl[] = [
  ...
  },
  {
    ...
    logistics: {
      ...
      pacingTips: 'Start in Belgravia, work through Soho and Marylebone, then tube to Kentish Town and Chiswick. Perfect pace for a relaxed afternoon.',
  ...
  },
  {
    ...
    description: 'Nine riverside pubs along the Thames from Blackfriars to Rotherhithe.',
    editorialDescription: "Start at the Arts and Crafts splendour of the Black Friar, cross to the South Bank for views of St Paul's and Shakespeare's Globe, then follow the river east past Tower Bridge to the Horniman at Hays Galleria. Keep going through Bermondsey and Rotherhithe, finishing at the Mayflower where the Pilgrim Fathers set sail.",
    duration: '5–6 hours',
    difficulty: 'Medium',
